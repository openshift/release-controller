...
func TestPayloadVerificationSync(t *testing.T) {
	...
	testCases := []struct {
		...
		name: "BlockingJobWithEmptyQualifier",
		input: &v1alpha1.ReleasePayload{
			ObjectMeta: metav1.ObjectMeta{
				Name:      "4.11.0-0.nightly-2022-02-09-091559",
				Namespace: "ocp",
		...
		name: "BlockingJobWithQualifierOverrides",
		input: &v1alpha1.ReleasePayload{
			ObjectMeta: metav1.ObjectMeta{
				Name:      "4.11.0-0.nightly-2022-02-09-091559",
				Namespace: "ocp",
		...
		name: "InformingJobWithQualifierOverrides",
		input: &v1alpha1.ReleasePayload{
			ObjectMeta: metav1.ObjectMeta{
				Name:      "4.11.0-0.nightly-2022-02-09-091559",
				Namespace: "ocp",
		...
		name: "UpgradeJobWithEmptyQualifier",
		input: &v1alpha1.ReleasePayload{
			ObjectMeta: metav1.ObjectMeta{
				Name:      "4.11.0-0.nightly-2022-02-09-091559",
				Namespace: "ocp",
		...
		name: "UpgradeJobWithQualifierOverrides",
		input: &v1alpha1.ReleasePayload{
			ObjectMeta: metav1.ObjectMeta{
				Name:      "4.11.0-0.nightly-2022-02-09-091559",
				Namespace: "ocp",
	...
	for _, testCase := range testCases {
		t.Run(testCase.name, func(t *testing.T) {
			...
			c, err := NewPayloadVerificationController(releasePayloadInformer, releasePayloadClient.ReleaseV1alpha1(), events.NewInMemoryRecorder("payload-verification-controller-test", clock.RealClock{}))
			if err != nil {
